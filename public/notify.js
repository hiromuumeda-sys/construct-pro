...
function renderNotif() {
  ...
  if (urgentUnconfirmed > 0) {
    badge.style.display = 'flex';
    badge.textContent = urgentUnconfirmed > 99 ? '99+' : urgentUnconfirmed;
  } else {
